<div class="container">
    ...
    <div class="container">
        <p style="text-align:center;">¿Eres una persona con experiencia y quisieras registrarte
            para que te puedan contrarar?</p>
        <a href="">Pincha aquí y regístrate para que puedan conocerte</a>
        <div class="row ">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6">
